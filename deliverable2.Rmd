...
### Note
This section of code takes approximately two minutes to run.  
...
After obtaining all of the data, we now want to organize it in a more condensed table. We are going to create a new table containing:
- date: in the format year-month-day that the game took place at  
